...
<table class="tg">
  ...
  <tr>
    ...
    <td class="tg-0lax"><a href="slides/session_2a-intro_to_ehr_data_quality.pdf">Clinical Data Quality Issues</a></td>
    <td class="tg-0lax">Lecture</td>
  ...
  <tr>
    ...
    <td class="tg-0lax"><a href="slides/session_3a_diabetes_demonstration.pdf">Applying the Clinical Wrangling Process: <br>Diabetes</a></td>
    <td class="tg-0lax">Lecture</td>
...
<table class="tg">
  ...
  <tr>
    ...
    <td class="tg-xldj"><a href="slides/session_4_race_and_ethnicity_slides.pdf">Assignment about race variable (assigned to groups)</a></td>
...
<table class="tg">
  ...
  <tr>
    ...
    <td class="tg-xldj"><a href="slides/session_4_race_and_ethnicity_slides.pdf">Discussion about race as a covariate, sharing of findings</a></td>
    <td class="tg-xldj">Discussion</td>
    <td class="tg-xldj">30 min</td>
  </tr>
  <tr>
    <td class="tg-xldj">5b</td>
    <td class="tg-xldj"><a href="slides/session_5_hypertension.pdf">Overview of hypertension and how it relates to Sleep <br>Apnea/Cardiovascular Disease</a></td>
